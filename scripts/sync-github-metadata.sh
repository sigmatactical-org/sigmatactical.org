...
declare -A DESCRIPTIONS=(
  ...
  [diagnostics]="A desktop application for viewing and analyzing CAN bus data from MDF4 files and live SocketCAN interfaces."
  ...
  [addresses]="Billing and shipping address service for Sigma Tactical Group commerce."
  [payments]="Payment methods service for Sigma Tactical Group commerce."
  ...
  [updates]="Package index and OTA update catalog for Sigma Tactical Group."
...
declare -A HOMEPAGES=(
  ...
  [catalog]="https://catalog.sigma-tactical.com"
  [cart]="https://cart.sigma-tactical.com"
  [orders]="https://orders.sigma-tactical.com"
  ...
  [sigma-racer]="https://sigmatactical.info"
...
declare -A TOPICS=(
  ...
  [diagnostics]="sigma-tactical rust can embedded gui network"
  [store]="sigma-tactical rust web ecommerce api storefront"
  ...
  [addresses]="sigma-tactical rust web ecommerce api addresses"
  [payments]="sigma-tactical rust web ecommerce api payments"
  ...
  [updates]="sigma-tactical rust api ota sigma-racer updates web"
